      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-rows-2 grid-cols-9 gap-4">
          ...
          >
            ...
            <div className="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-8 md:pl-72">
              <h5 className="text-lg font-semibold">Living Room</h5>
              <span className="">18.309</span>
            </div>
          ...
          <div className="relative col-span-9 row-span-1 md:col-span-4 card">
            ...
            {/* <a href="#" className="stretched-link">fake children</a> */}
          </div>
        </div>
      </div>
    </section>
