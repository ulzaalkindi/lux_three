                ...
                <div className='relative hero-image'>
                    ...
                    <div className='overlay right-0 bottom-0 md:inset-0'>
                        <button className='video hero-cta focus:outline-none z-30 modal-trigger'
                            data-content='<div class="w-screen pb-56 md:w-80 md:pb-56 relative z-40">
                    ...
                    <img src='images/content/image-section-1.png'
                        alt='hero 1' className='absolute inset-0 md:relative w-full h-full object-cover object-center' />
                </div>
