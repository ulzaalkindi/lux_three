      ...
      <div className="container mx-auto py-5">
        <div className="flex items-center">
          <div className="w-56 items-center flex">
            <Link to="/">
              <img
                ...
                alt="Luxspace | Fulfill your house with beatiful furniture"
              />
            </Link>
          </div>
          ...
          <div className="w-auto">
            <ul
              id="menu"
              className="fixed bg-white inset-0 flex flex-col invisible items-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
            >
